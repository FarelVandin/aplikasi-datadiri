...
<form action="input-datadiri-edit.php" method="POST">
    ...
    <input class="form-control" type="number" value="<?php echo $row["nis"]; ?>" name="nis" placeholder="Ex. 12003102" readonly/><br>

    <label for="nis">Nama Lengkap :</label>
    <input class="form-control" type="text" value="<?php echo $row["namalengkap"]; ?>" name="nama" placeholder="Ex. Agung Aryanto"/><br>

    <label for="tanggal_lahir">Tanggal Lahir :</label>
    <input class="form-control" type="date" value="<?php echo $row["tanggal_lahir"]; ?>" name="tanggal_lahir"/><br>

    <label for="nilai">Nilai :</label>
    <input class="form-control" type="number" value="<?php echo $row["nilai"]; ?>" name="nilai"/><br>
