...
<form action="kwu-edit.php" method="POST"> 
    ...
    <input class="form-control" value="<?php echo $row["kodebarang"]; ?>" type="text" name="kodebarang" readonly/><br>
    ...
    <input  class="form-control" value="<?php echo $row["namabarang"];?>" type="text" name= "namabarang" /><br><br>
